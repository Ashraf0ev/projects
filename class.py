...
def people():
    ...
    aleksandr = Person.create(name='Aleksandr', birthday='2006-08-25')
    alibek = Person.create(name='Alibek', birthday='2006-04-19')
    xusan = Person.create(name='Xusan', birthday='2006-08-11')
    otabek = Person.create(name='Otabek', birthday='2006-12-21')
